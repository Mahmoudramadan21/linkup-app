...
const BioSkeleton: React.FC = memo( () => {
  return (
    <div
      className={`${styles['profile-content__bio_card']} animate-pulse`}
      role="region"
      aria-busy="true"
      aria-live="polite"
    ...
    >
      ...
      <div className={styles['profile_bio__header']}>
        <div className="h-6 w-20 rounded bg-neutral-gray" />
        <div className="h-6 w-6 rounded bg-neutral-gray" />
      </div>

      {/* Bio text placeholder */}
      <div className="mb-4 h-4 w-3/4 rounded bg-neutral-gray" />
      ...
      <div className={styles['profile_bio__details']}>
        {Array.from({ length: 2 }, (_, index) => (
          ...
          >
            {/* Icon placeholder */}
            <div className="h-5 w-5 rounded bg-neutral-gray" />
            {/* Text placeholder */}
            <div className="h-4 w-1/2 rounded bg-neutral-gray" />
          </div>
        ))}
      </div>
    </div>
